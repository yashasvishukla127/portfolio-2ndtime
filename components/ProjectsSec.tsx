...
const ProjectsSec = (props: Props) => {
  return (
    ...
    justify-evenly mx-auto items-center   ' style={{height:'2000px'}} >
        {/* <h3 className='text-4xl font-extrabold absolute top-24 tracking-[12px] text-[#F94C10] shadow-2xl shadow-orange-500'> PROJECTS</h3> */}
        <AnimatedText className='text-[#525CEB] shadow-[#0766AD] shadow-2xl' text ="PROJECTS"/>
        <div className='w-full  absolute space-x-5 overflow-x-scroll p-10 snap-x snap-mandatory top-[10%] mb-7 grid grid-cols-2 gap-y-20 '>
