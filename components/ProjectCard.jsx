...
const ProjectCard = ({name ,link ,image,tech1 , tech2 , tech3, 
    tech1img ,tech2img , tech3img ,data}) => {
  return (
     ...
     transition-opacity duration-1000 overflow-hidden relative '>
        <div className='flex flex-col relative left-[45%]'>
            <motion.div initial={{x:-200,opacity:0,}}
                ...
                className=''>
                <h4 className='font-bold text-center text-blue-200 hover:text-black uppercase relative left-[-45%] text-2xl mt-2'>{name}</h4>
        ...
        <p className='text-center absolute top-5 right-5 w-[280px]
        uppercase text-black '>{data}</p>
    </article>
  )
